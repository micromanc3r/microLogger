#
#  Be sure to run `pod spec lint microLogger.podspec' to ensure this is a
...
Just select appropriate loglevel for your debug or production build and you do not have to worry about printing something inappropriate in production.
  ...
  # Or just: s.author    = "Miroslav Sliacky"
  # s.authors            = { "Miroslav Sliacky" => "micromanc3r@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Miroslav Sliacky"
